#!/bin/bash
#
#  remote-directory-backup.sh - shell script template for time-machine
#  or plain rsync-based backups of a remote directory
#
...
# plain_backup_remotedir "/home/user/" "$excludes" home_user
